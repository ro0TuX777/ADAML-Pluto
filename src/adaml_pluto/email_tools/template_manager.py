...
I noticed that {company} is doing great work in {industry}. I wanted to reach out \
because I think our solution could help with {pain_point}.
...
I wanted to follow up on my previous email about {topic}. I understand you're busy, \
but I genuinely believe this could be valuable for {company}.
...
{sender_name}""",
    ...
    def save_templates(self) -> None:
        ...
        templates_data = {name: template.to_dict() for name, template in self.templates.items()}
